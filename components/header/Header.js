...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex items-center p-2 lg:px-5 shadow-md">
      {/* Left */}
      ...
      <div className="flex items-center sm:space-x-2 justify-end">
        ...
        <ViewGridIcon className="icon text-pink-500" />
        <ChatIcon className="icon text-blue-500" />
        <BellIcon className="icon text-yellow-500" />
        <ChevronDownIcon className="icon text-red-500" />
      </div>
    </header>
  );
}
